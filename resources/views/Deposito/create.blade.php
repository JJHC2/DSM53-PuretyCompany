...
<div class="main-panel" id="main-panel">
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Alta Deposito</h4>
          </div>
          <form action="{{ url('deposito')}}" id="agregar" method="post" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="form-floating mb-3">
              <input type="number" class="form-control" id="codigo" placeholder="Ejemplo: 1242" name="codigo" required>
              <label for="floatingInput">Codigo</label>
          </div>
          <div class="form-floating mb-3">
            <input type="number" class="form-control" id="capacidad" placeholder="Ejemplo: 200L" name="capacidad" required>
            <label for="floatingInput">Capacidad</label>
        </div>
        <div class="form-floating mb-3">
          <input type="text" class="form-control" id="Lugar" placeholder="Ejemplo: Lerma de Villada" name="Lugar" required>
  ...
  <a href="/deposito" class="btn btn-danger m-3">Cancelar</a>
